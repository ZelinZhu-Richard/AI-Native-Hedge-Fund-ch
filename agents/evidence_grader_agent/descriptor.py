...
DESCRIPTOR = AgentDescriptor(
    ...
    objective="Assess whether a candidate thesis is sufficiently grounded to proceed to human review.",
    ...
    failure_modes=["overstated support", "missing gaps", "implicit confidence inflation"],
