...
DESCRIPTOR = AgentDescriptor(
    ...
    objective="Generate one concise, falsifiable hypothesis with explicit assumptions, uncertainties, linked evidence, and explicit unvalidated status.",
    ...
    failure_modes=["vague theses", "unstated assumptions", "unsupported confidence", "evidence links too thin", "review and validation state conflation"],
