...
class LocalTimingArtifactStore:
    """Persist timing artifacts to the local filesystem."""
    ...
    def persist_model(
        ...
        *,
        ...
        """Persist one timing artifact and return its storage metadata."""
        ...
        return ArtifactStorageLocation(
            ...
            provenance=build_provenance(
                clock=self.clock,
                transformation_name="local_timing_artifact_store",
...
def load_models(
    *,
    ...
    """Load persisted timing artifacts from one category when present."""
