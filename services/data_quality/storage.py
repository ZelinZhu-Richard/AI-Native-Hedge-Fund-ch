...
class LocalDataQualityArtifactStore:
    """Persist data-quality artifacts to the local filesystem."""
    ...
    def persist_model(
        ...
        *,
        ...
        """Persist one typed data-quality artifact and return storage metadata."""
        ...
        return persist_local_model(
            ...
            clock=self.clock,
            transformation_name="local_data_quality_artifact_store",
        )
