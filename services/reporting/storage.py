...
class LocalReportingArtifactStore:
    """Persist reporting artifacts under the local reporting root."""
    ...
    def persist_model(
        ...
        *,
        ...
        """Persist one typed reporting artifact and return storage metadata."""
        ...
        return persist_local_model(
            ...
            clock=self.clock,
            transformation_name="local_reporting_artifact_store",
        )
