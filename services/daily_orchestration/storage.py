...
class LocalOrchestrationArtifactStore:
    """Persist orchestration artifacts to the local filesystem."""
    ...
    def persist_model(
        ...
        *,
        ...
        """Persist one orchestration artifact and return storage metadata."""
        ...
        return persist_local_model(
            ...
            clock=self.clock,
            transformation_name="local_orchestration_artifact_store",
        )
...
def load_models(
    *,
    ...
    """Load persisted orchestration artifacts from one category when present."""
