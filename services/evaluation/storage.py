...
class LocalEvaluationArtifactStore:
    """Persist Day 10 evaluation artifacts to the local filesystem."""
    ...
    def persist_model(
        ...
        *,
        ...
        """Persist one typed evaluation artifact and return storage metadata."""
        ...
        return persist_local_model(
            ...
            clock=self.clock,
            transformation_name="local_evaluation_artifact_store",
        )
