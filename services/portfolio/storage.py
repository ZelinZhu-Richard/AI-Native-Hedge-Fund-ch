...
class LocalPortfolioArtifactStore:
    """Persist Day 7 portfolio artifacts to the local filesystem."""
    ...
    def persist_model(
        ...
        *,
        ...
        """Persist one typed portfolio artifact and return storage metadata."""
        ...
        return ArtifactStorageLocation(
            ...
            provenance=build_provenance(
                clock=self.clock,
                transformation_name="local_portfolio_artifact_store",
