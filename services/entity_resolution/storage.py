...
class LocalEntityResolutionArtifactStore:
    """Persist entity-resolution artifacts to the local filesystem."""
    ...
    def persist_model(
        ...
        *,
        ...
        """Persist one typed entity-resolution artifact and return storage metadata."""
        ...
        return ArtifactStorageLocation(
            ...
            provenance=build_provenance(
                clock=self.clock,
                transformation_name="local_entity_resolution_artifact_store",
...
def load_models(
    *,
    ...
    """Load persisted entity-resolution artifacts from one category when present."""
